...
|------------------------------|---------------|
| ConnectCommon                | 0.1.40        |
| ParticleConnect              | 0.1.40        |
| ConnectWalletConnectAdapter  | 0.1.40        |
| ConnectEVMConnectAdapter     | 0.1.40        |
| ConnectPhantomConnectAdapter | 0.1.40        |
| ConnectSolanaConnectAdapter  | 0.1.40        |
