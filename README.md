...
|------------------------------|---------------|
| ConnectCommon                | 0.2.2        |
| ParticleConnect              | 0.2.2        |
| ConnectWalletConnectAdapter  | 0.2.2        |
| ConnectEVMConnectAdapter     | 0.2.2        |
| ConnectPhantomConnectAdapter | 0.2.2        |
| ConnectSolanaConnectAdapter  | 0.2.2        |
