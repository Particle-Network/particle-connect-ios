...
|------------------------------|---------------|----------|
| ConnectCommon                | 0.1.25        | 0.1.24.1 |
| ParticleConnect              | 0.1.25        | 0.1.24.1 |
| ConnectWalletConnectAdapter  | 0.1.25        | 0.1.24.1 |
| ConnectEVMConnectAdapter     | 0.1.25        | 0.1.24.1 |
| ConnectPhantomConnectAdapter | 0.1.25        | 0.1.24.1 |
| ConnectSolanaConnectAdapter  | 0.1.25        | 0.1.24.1 |
