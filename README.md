...
|------------------------------|---------------|
| ConnectCommon                | 0.1.39        |
| ParticleConnect              | 0.1.39        |
| ConnectWalletConnectAdapter  | 0.1.39        |
| ConnectEVMConnectAdapter     | 0.1.39        |
| ConnectPhantomConnectAdapter | 0.1.39        |
| ConnectSolanaConnectAdapter  | 0.1.39        |
