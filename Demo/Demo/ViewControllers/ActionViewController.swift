...
class ActionViewController: UIViewController {
    ...
    @IBAction func addEthereumChain() {
        ...
        let chainInfo = ParticleNetwork.ChainInfo.kcc(.mainnet)
        let chainId: Int = chainInfo.chainId
...
extension ActionViewController {
    ...
    private func getTransactionNative() -> Single<String> {
        if isSolana() {
            ...
            return ParticleWalletAPI.getEvmService().createTransaction(from: getSender(), to: "0x0cF3Ffe33E45ad43fcd0aa7016C590b5F629d9AA", value: BInt(123456).toHexString(), data: "0x")
        }
    }
